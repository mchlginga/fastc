...
const FileViewerModal = ({ isOpen, onClose, fileUrl, fileName, fileType }) => {
    ...
    return (
        <div
            className="fixed inset-0 bg-black/90 flex items-center justify-center z-[101] p-4"
            onClick={onClose}
        >
            <div
                className="relative max-w-4xl w-full max-h-[90vh] bg-white rounded-lg overflow-hidden border border-gray-200"
