            ...
            >
                ...
                <div className="p-4 space-y-3">
                    ...
                    <div className="bg-orange-50 border border-orange-200 rounded p-3">
                        <p className="text-sm text-orange-800">
                            <strong>Note:</strong> Regenerating this certificate
                            will:
                        </p>
                ...
                <div className="flex justify-end gap-2 p-4 border-t border-gray-300 bg-gray-50">
                    ...
                    <button
                        ...
                        disabled={regenerating}
                        className="px-4 py-2 text-sm text-white bg-orange-600 rounded hover:bg-orange-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors cursor-pointer"
                    >
                        {regenerating ? (
