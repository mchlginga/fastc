                ...
                values.map((value) => (
                    ...
                    >
                        ...
                        <button
                            ...
                            className="ml-2 focus:outline-none cursor-pointer hover:text-blue-800 transition-colors"
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            ...
                            <button
                                ...
                                className="flex items-center px-4 py-2.5 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-lg cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed shadow-xs transition-colors"
                                title={
                                    isPendingCompany
                            ...
                            <div className="max-w-md mx-auto">
                                ...
                                {hasFilters && (
                                    <button
                                        ...
                                        className="px-4 py-2.5 text-sm font-medium text-blue-600 hover:text-blue-700 cursor-pointer transition-colors"
                                    >
                                        Clear all filters
                                    </button>
                                )}
