...
const AttendanceTableRow = ({ record, onManualVerification, rowIndex }) => {
    ...
    return (
        <tr className="border-b border-gray-100 transition-all duration-200 hover:bg-gray-50/80">
            {/* Trainee Info */}
            <td className="pl-6 pr-4 py-4 whitespace-nowrap">
                <div className="flex items-center group">
                    ...
                    <div className="ml-3">
                        <div className="text-sm font-medium text-gray-900 truncate max-w-160 group-hover:text-gray-700 transition-colors">
            ...
            <td className="px-4 py-4 whitespace-nowrap">
                <span
                    className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border transition-all duration-200 ${methodConfig.bg} ${methodConfig.text} ${methodConfig.border}`}
                >
                    {methodConfig.label}
                </span>
            </td>
