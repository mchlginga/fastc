...
const AddCourseModal = ({ isOpen, onClose, onCourseAdded }) => {
    ...
    const [imageUploading, setImageUploading] = useState(false); // 🆕 ADD: Image upload state
    ...
    const resetForm = useCallback(() => {
        ...
        setNewRequirement("");
        setNewOutcome("");
        setImagePreview(null); // 🆕 RESET: Clear image preview
    }, []);
        ...
        setFormData((prev) => ({
            ...
            lessons: [
                ...prev.lessons,
                {
                    ...
                    content: "",
                    isRequired: true,
                    videoUrl: "", // 🆕 ADD: Video URL for lessons
                },
            ],
        }));
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // ACTUAL API CALL - Remove the console.log mock
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 cursor-pointer">
            ...
            >
                ...
                >
                    ...
                    {/* 🆕 ADD: Enrollment Period and End Date */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1 cursor-pointer">
